...
<div class="container">
      ...
      <div class="col-12 col-lg-6">
        <div class="d-flex border">
          ...
          <div class="content p-3">
            <p><b>Ferramentas de Automação Titulo maior aqui</b></p>
    ...
    <div class="row mt-5 border py-4 m-1">
        <form class="d-flex justify-content-center align-items-center flex-column flex-lg-row">
          <div class="text-center col-12 col-lg-4 text-white"><h3>Assine a nossa newsletter</h3></div>
